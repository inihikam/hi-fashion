...
@section('title')
    Hi-Fashion - Transaction Details
@endsection
    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                <h2 class="dashboard-title">Transaction Details - {{ $transaction->code }}</h2>
                <p class="dashboard-subtitle">Check your payment today!</p>
            </div>
                                    ...
                                    <div class="col-12 col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="product-subtitle">
                                                    ${{ number_format($transaction->transaction->total_pay) }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
