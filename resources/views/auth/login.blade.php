            ...
            <div class="container">
                <div class="row align-items-center row-login">
                    <div class="col-lg-6 text-center">
                        <img src="/images/logo.svg" alt="" class="w-50 mb-4 mb-lg-none" />
                    </div>
                    <div class="col-lg-5">
                        <h2>Shop your heart out,<br />own your lifestyle.</h2>
                        <form method="POST" action="{{ route('login') }}" class="mt-3">
                            ...
                            <a href="{{ route('register') }}" class="btn btn-secondary btn-block w-75 mt-2">
                                Sign Up
                            </a>
                        </form>
                    </div>
